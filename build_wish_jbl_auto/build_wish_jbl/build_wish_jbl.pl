...
my $Book = $Excel->Workbooks->Open("E:\\tool\\build_wish_jbl\\$newxlsx") //  die "Can not open $newxlsx book\n" ;	
...
my (%colorsize);
my $wish_num = 2;
my $mydir = "E:/tool/build_wish_jbl/imgdir/$huohao";
